function [ M ] = prism_M( X,Y,Z,weights,pts )
%Assemble mass matrix over an element by Gauss quadrature
...
%f = @(xi1,xi2,xi3) (I(i,:)*...
%           (prism_nonhom_preM_bi([xi1;xi2;xi3])'*...
%            prism_nonhom_preM_bi([xi1;xi2;xi3]))*...
%            I(:,j))*...
...
for r=1:54
    eval(r) = (I(i,:)*...
              (prism_nonhom_preM_bi([pts(r,1),pts(r,2),pts(r,3)])'*...
               prism_nonhom_preM_bi([pts(r,1),pts(r,2),pts(r,3)]))*...
               I(:,j))*...
